...
async def iq(iqthonevent):
    ...
    ALIVE_TEXT = gvarstatus("ALIVE_TEXT") or "ٍّّ𝘀ُُ𝗼ًًٍٍ𝗨ًًٍٍ𝗥ََِِ𝗰ََِِ𝗲 ََِِ𝗰ًًٍٍ𝗥ٍٍَ𝗶ٍّّ𝘀ٖٔ𝗧ََِِ𝗲ٍٍّّ𝗡𓃠"
...
async def amireallyalive(event):
    ...
    IQTHON_ALIVE_TEXT = "❬ تـليثون كرستين - Cris-Arabe ، 🕸  ❭ :"
...
async def _(event):
    ...
    OUTPUT = (f"⎈ ⦙  وحـدة المعلومات الخاصه بتنصيبك مع جميع الفارات  لتنصيب سورس تليثون @cr_source :**\n\n{o}")
...
if Config.TG_BOT_USERNAME is not None and tgbot is not None:
    ...
    async def inlineiqthon(iqthon):
        ...
        if query.startswith("تنصيب") and iqthon.query.user_id == bot.uid:
            buttons = [[Button.url("1- شرح التنصيب", "https://youtu.be/44tYK_yV02Q"), Button.url("2- استخراج ايبيات", "https://my.telegram.org/"),],[Button.url("3- ستخراج تيرمكس", "hhttp://t.me/u_7_gbot"), Button.url("4- بوت فاذر", "http://t.me/BotFather"),],[Button.url("5- رابط التنصيب", "https://dashboard.heroku.com/new?template=https://github.com/wjj_u/Help"),],[Button.url("المطـور 👨🏼‍💻", "https://t.me/cr_cr_cr"),]]
