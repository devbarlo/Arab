...
LOGS = logging.getLogger("تليثون كرستين\n ")
...
async def startupmessage():
    try:
        if BOTLOG:
            Config.CATUBLOGO = await iqthon.tgbot.send_file(BOTLOG_CHATID, "https://telegra.ph/file/54699e9f531dfac087926.jpg", caption="**⎈ ⦙ تـمّ تـحديـث تليثـون السلطان ✓  :**  [ 7.4 ] \n \n**⎈ ⦙ للحصول على اوامر السورس أرسل :** (  `.الاوامر`  ) \n**⎈ ⦙ يحتاج لتفعيل اونلاين أو أرسل :** (  `.اوامري`  )\n\n**⎈ ⦙ القناة الرسمية : @cr_source **\n**⎈ ⦙ فارات سورس كرستين  : @cr_source **\n**⎈ ⦙ كلايش تليثون :  @q_k_2**",                buttons=[(Button.url("مجموعه تليثون", "https://t.me/gro_up_1"),)],            )
    except Exception as e:
        LOGS.error(e)
        return None
